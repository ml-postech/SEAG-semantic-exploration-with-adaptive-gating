...
class Llama2Model(LanguageModel):
    ...
    def generate(self,
        ...
        for i, (t, input_t) in enumerate(zip(tokens.tolist(), prompt_tokens)):
            ...
            out_tokens_count += len(self.tokenizer.encode(decoded_tokens, bos=False, eos=False))
        return GenerateOutput(decoded, log_prob), input_tokens_count, out_tokens_count
