...
class ARCEvaluator(Evaluator):
    def __init__(self, 
                 ...
                 dataset_path: str = r"/path/to/llm-reasoners/dataset/ARC",) -> None:

        self.init_prompt = init_prompt
        self.output_extractor = output_extractor
        self.answer_extractor = answer_extractor
        self.input_processor = lambda x: x["question"]
        self.full_dataset = data_reader('test_sampled400', dataset_path)
        self._dataset_name = 'ARC'
    ...
    def eval_output(self, answer, output):
        ...
        return output[0].lower() == answer.lower()